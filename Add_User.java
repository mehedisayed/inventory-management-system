...
public class Add_User extends JPanel implements ActionListener
{
	JPanel pnladd_user;
	...
	public Add_User()
	{
		...
		if (e.getSource()==btnsubmit)
		{
			...
			if(cmbdept.getSelectedItem().equals("manager"))
			{
				Database dbadduser = new Database();
				dbadduser.adduser(txtusername.getText(),ptxtpassword.getText(),2);
			}
			else if(cmbdept.getSelectedItem().equals("salesman"))
			{
				Database dbadduser = new Database();
